...
public class SearchAdapter extends RecyclerView.Adapter<SearchAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull SearchAdapter.ViewHolder holder, int position) {
        ...
        holder.difficultyLevel.setTextColor(Helper.getDifficultyColour(hike.getDifficultyID(), context));
        holder.difficultyLevel.setText(hike.getDifficultyLevel());
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            difficultyLevel = itemView.findViewById(R.id.lblHikeDifficultySearch);
